...
from example_1 import window_cam
...
def detectme(request):
    try:
        return window_cam.open_cam('http://192.168.0.174:8080/shot.jpg')
        return render(request, 'example_1/webcam.html')
        # return StreamingHttpResponse(window_cam.open_cam('http://192.168.0.174:8080/shot.jpg'))
